...
public class dialogPersonEditNew extends DialogFragment {
    ...
    public static dialogPersonEditNew newInstance(@NonNull String userUid, @NonNull String diveLogUid,
                                                  int buttonID, @NonNull String personJson) {
    ...
    private void trySavingPerson(final Person proposedPerson) {
        ...
        Person.nodeUserPersons(mUserUid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                continueTryingToSavePerson();
            }

            private void continueTryingToSavePerson() {
                ...
                if (Person.okToSavePerson(personList, proposedPerson)) {
                    Person.save(mUserUid, proposedPerson);
                    DiveLog.updateDiveLogsWithPerson(mUserUid, proposedPerson);
                    dismiss();
