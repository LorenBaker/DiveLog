...
//    private static final String TAG = com.firebase.ui.database.FirebaseListAdapter.class.getSimpleName();
     ...
     */
    public FirebaseListAdapter(Activity activity, Class<T> modelClass,
                               int modelLayout, Query ref, String userUid) {
        this(activity, modelClass, modelLayout, new MyFirebaseArray(ref, AppMetrics.nodeDiveLogArraySize(userUid)));
    }
